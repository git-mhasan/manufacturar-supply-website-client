            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center items-center'>
                <div className="stats shadow">
                    <div className="stat">
                        ...
                        <div className="stat-title">We have Served</div>
                        <div className="stat-value">100+</div>
                        <div className="stat-desc">Happy client in 3 years</div>
                    </div>
                ...
                <div className="stats shadow">
                    <div className="stat">
                        ...
                        <div className="stat-title">We have received</div>
