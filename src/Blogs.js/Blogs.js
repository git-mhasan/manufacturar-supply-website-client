...
const Blogs = () => {
    return (
        <div className='mx-5 flex-col text-justify '>
            ...
            <div>
                <h2><span className='font-bold'>Question 14.1</span> How will you improve the performance of a React Application?</h2>
                <p><span className='font-bold text-green-500'>Answer: </span>
            ...
            {/* <div className='mt-4'>
                <h2><span className='font-bold'>Question 14.2</span> What are the different ways to manage a state in a React application?</h2>
                <p><span className='font-bold text-green-500'>Answer:</span> Here us the ans</p>
            </div> */}
            <div className='mt-4'>
                <h2><span className='font-bold'>Question 14.3</span> How does prototypical inheritance work?</h2>
            ...
            <div className='mt-4'>
                <h2><span className='font-bold'>Question 14.4</span> Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts</h2>
                <p><span className='font-bold text-green-500'>Answer:</span>
                    We should never update the state directly in React because:
                    <p className='mx-4'>
            ...
            <div className='mt-4'>
                <h2><span className='font-bold'>Question 14.5</span> You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h2>
                <p><span className='font-bold text-green-500'>Answer:</span>
                    <p className='mx-4'>
            ...
            <div className='my-4'>
                <h2><span className='font-bold'>Question 14.6</span> What is a unit test? Why should write unit tests?</h2>
                <p><span className='font-bold text-green-500'>Answer:</span> Unit tests, a type of functional test that allows progremmer to test a module while deeveloping a large scalled sftware/application.
                    <br />
